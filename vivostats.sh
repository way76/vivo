...
echo "Contabo_MN10_03  Conferme: $(Calcola_LP_Vivo $MN03_VIVO) - $(Calcola_Status_Vivo $MN03_VIVO) - $(Calcola_LastSeen_Vivo $MN03_VIVO)"
echo "Contabo_MN10__04  Conferme: $(Calcola_LP_Vivo $MN04_VIVO) - $(Calcola_Status_Vivo $MN04_VIVO) - $(Calcola_LastSeen_Vivo $MN04_VIVO)"
echo "Contabo_MN10__05  Conferme: $(Calcola_LP_Vivo $MN05_VIVO) - $(Calcola_Status_Vivo $MN05_VIVO) - $(Calcola_LastSeen_Vivo $MN05_VIVO)"
echo "Contabo_MN10__06  Conferme: $(Calcola_LP_Vivo $MN06_VIVO) - $(Calcola_Status_Vivo $MN06_VIVO) - $(Calcola_LastSeen_Vivo $MN06_VIVO)"
echo "Contabo_MN10__07  Conferme: $(Calcola_LP_Vivo $MN07_VIVO) - $(Calcola_Status_Vivo $MN07_VIVO) - $(Calcola_LastSeen_Vivo $MN07_VIVO)"
echo "Contabo_MN10__08  Conferme: $(Calcola_LP_Vivo $MN08_VIVO) - $(Calcola_Status_Vivo $MN08_VIVO) - $(Calcola_LastSeen_Vivo $MN08_VIVO)"
echo "Contabo_MN10__09  Conferme: $(Calcola_LP_Vivo $MN09_VIVO) - $(Calcola_Status_Vivo $MN09_VIVO) - $(Calcola_LastSeen_Vivo $MN09_VIVO)"
echo "Contabo_MN10__10  Conferme: $(Calcola_LP_Vivo $MN10_VIVO) - $(Calcola_Status_Vivo $MN10_VIVO) - $(Calcola_LastSeen_Vivo $MN10_VIVO)"
echo "Contabo_MN10__11  Conferme: $(Calcola_LP_Vivo $MN11_VIVO) - $(Calcola_Status_Vivo $MN11_VIVO) - $(Calcola_LastSeen_Vivo $MN11_VIVO)"
echo "Contabo_MN10__12  Conferme: $(Calcola_LP_Vivo $MN12_VIVO) - $(Calcola_Status_Vivo $MN12_VIVO) - $(Calcola_LastSeen_Vivo $MN12_VIVO)"
echo "Contabo_MN10__13  Conferme: $(Calcola_LP_Vivo $MN13_VIVO) - $(Calcola_Status_Vivo $MN13_VIVO) - $(Calcola_LastSeen_Vivo $MN13_VIVO)"
echo "Contabo_MN10__14  Conferme: $(Calcola_LP_Vivo $MN14_VIVO) - $(Calcola_Status_Vivo $MN14_VIVO) - $(Calcola_LastSeen_Vivo $MN14_VIVO)"
echo "Contabo_MN10__15  Conferme: $(Calcola_LP_Vivo $MN15_VIVO) - $(Calcola_Status_Vivo $MN15_VIVO) - $(Calcola_LastSeen_Vivo $MN15_VIVO)"
echo "Contabo_MN10__16  Conferme: $(Calcola_LP_Vivo $MN16_VIVO) - $(Calcola_Status_Vivo $MN16_VIVO) - $(Calcola_LastSeen_Vivo $MN16_VIVO)"
echo "Contabo_MN10__17  Conferme: $(Calcola_LP_Vivo $MN17_VIVO) - $(Calcola_Status_Vivo $MN17_VIVO) - $(Calcola_LastSeen_Vivo $MN17_VIVO)"
echo "Contabo_MN10__18  Conferme: $(Calcola_LP_Vivo $MN18_VIVO) - $(Calcola_Status_Vivo $MN18_VIVO) - $(Calcola_LastSeen_Vivo $MN18_VIVO)"
echo "Contabo_MN10__19  Conferme: $(Calcola_LP_Vivo $MN19_VIVO) - $(Calcola_Status_Vivo $MN19_VIVO) - $(Calcola_LastSeen_Vivo $MN19_VIVO)"
echo "Contabo_MN10__20  Conferme: $(Calcola_LP_Vivo $MN20_VIVO) - $(Calcola_Status_Vivo $MN20_VIVO) - $(Calcola_LastSeen_Vivo $MN20_VIVO)"
